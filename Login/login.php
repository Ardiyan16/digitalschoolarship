        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-6">
              ...
              <p class="text-lead text-light">para calon developer website, silahkan lakukan login terlebih dahulu</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card bg-secondary shadow border-0">
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" action="proseslogin.php" method="post">
                ...
                <div class="forgot" style="font-size: 13px; margin-left: 65%;">
                ...
                <div class="text-center" style="font-size:12px;">
                  <p style="font-size:12px;">Dont have an acount ? <a href="registrasi.php">Sign Up acount</a></p>
                </div>
              </form>
            </div>
          </div>
