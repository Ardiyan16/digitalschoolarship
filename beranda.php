...
<body>
  ...
  <section class="section-margin mb-5 pb-5">
    <div class="container">
      <div class="section-intro text-center pb-98px">
        <h3 class="primary-text">Tahapan Pendaftaran Digital Talent Schoolarship 2019</h3>
          ...
          <div class="scheduleTab">
            <ul class="nav nav-tabs">
              ...
              <li class="nav-item text-center">
                ...
                <a data-toggle="tab" href="#day2"><img src="img/substansi.png" height="120" width="120"></a>
                <h4>Tes Substansi Online</h4>
                </a>
              </li>
              <li class="nav-item text-center">
                <h1 class="text-center">3</h1>
                <a data-toggle="tab" href="#day3"><img src="img/verifikasi.png" height="120" width="120"></a>
                <h4>Verifikasi Berkas</h4>
                </a>
              </li>
              <li class="nav-item text-center">
                <h1 class="text-center">4</h1>
                <a data-toggle="tab" href="#day4"><img src="img/pelatihan.png" height="120" width="120"></a>
                <h4>Pelatihan</h4>
                </a>
              </li>
            </ul>
            ...
            <section class="section-padding bg-gray">
              <div class="container">
                <div class="section-intro text-center pb-98px">
                  <h2 class="primary-text">Kategori Peserta Pelatihan</h2>
                  <img src="template/img/home/section-style.png" alt="">
                </div>
                ...
                <div class="row">
                  <div class="col mb-4 mb-lg-0">
                    <div class="text-center card-priceTable">
                      ...
                      <div class="icon-peserta-umum">
                        <img src="img/team.png" width="300" height="300">
                      </div>
                      <div class="priceTable-footer">
                        <a class="button" href="#">Lihat Selengkapnya</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col mb-4 mb-lg-0">
                    <div class="text-center card-priceTable">
                      ...
                      <div class="icon-peserta-umum">
                        <img src="img/disabilitas.png" width="300" height="300">
                      </div>
                      <div class="priceTable-footer">
                        <a class="button" href="#">Lihat Selengkapnya</a>
                      </div>
