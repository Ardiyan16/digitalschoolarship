                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="../input/inputperti.php"><i class="fa fa-file-text-o"></i> Input Data Perti</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_array($query)) {
                                            ...
                                            <tr>
                                                ...
                                                <th><img src="../../uploads/<?php echo $row['images'] ?>" width="100" height="100"></th>
                                                <th>
                                                    <a href="" class="btn btn-small"><i class="fa fa-edit"></i>Edit</a>
                                                    <a onclick="deleteConfirm" href="" class="btn btn-small text-danger"><i class="fa fa-trash-o"></i>
                                                </th>
                                            <?php } ?>
                                    </tbody>
                                </table>
