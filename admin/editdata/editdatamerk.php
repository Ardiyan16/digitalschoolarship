...
$data = mysqli_query($koneksi, "SELECT * FROM data where no='" . $_GET['no'] . "'");
$edit = mysqli_fetch_array($data);

$nama_merk = $edit['nama_merk'];
$warna = $edit['warna'];
$jumlah = $edit['jumlah'];
?>
<?php
                    ...
                    <div class="box-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?= $nama_merk ?>" name="nama_merk" placeholder="Nama merk">
                            </div>
                            <div class="form-group">
                                <label>warna</label>
                                <input type="text" class="form-control" name="warna" value="<?= $warna ?>" placeholder="Warna">
                            </div>
                            <div class="form-group">
                                <label>Jumlah</label>
                        ...
                        if (isset($_POST['simpan'])) {
                            ...
                            if ($nama_merk != '') {
                                $update = mysqli_query($koneksi, "UPDATE data SET 
                                nama_merk= '" . $nama_merk . "', 
                                warna= '" . $warna . "', 
                                jumlah= '" . $jumlah . "'
                                WHERE no= '" . $_GET['no'] . "'
